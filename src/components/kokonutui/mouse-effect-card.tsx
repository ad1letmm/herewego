        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-2">
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="mt-2 flex items-center gap-3">
              <Button className="rounded-full shadow-lg" size="lg" render={<a href={primaryCtaUrl} onClick={(e) => {
                                              if (primaryCtaUrl === "#") {
                                                e.preventDefault();
                                              }
                                            }} />} nativeButton={false}>{primaryCtaText}</Button>
              {secondaryCtaText && (
                <Button className="rounded-full" size="lg" variant="outline" render={<a href={secondaryCtaUrl} onClick={(e) => {
                                                    if (secondaryCtaUrl === "#") {
                                                      e.preventDefault();
                                                    }
                                                  }} />} nativeButton={false}>{secondaryCtaText}</Button>
              )}
            </div>
          </div>
        </div>
